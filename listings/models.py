...
from smart_stay.models import smart_stays
...
class Listing(models.Model):
    ...
    smart_stays=models.ForeignKey(smart_stays,on_delete=models.DO_NOTHING) #when agent is deleted, the listing remains

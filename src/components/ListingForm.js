...
const ListingForm = (props) => {
    ...
    const onSubmit = e => {
        ...
        setLoading(true);
        axios.post(`http://104.236.207.118/api/listings/search`, {sale_type, price, bedrooms, home_type, bathrooms, sqft, days_listed, has_photos, open_house, keywords }, config)
        .then(res => {
            setLoading(false);
                ...
                <div className='col-1-of-6'>
                    <div className='listingform__section'>
                        ...
                        <select className='listingform__select' name='price' onChange={e => onChange(e)} value={price}>
                            <option>R0+</option>
                            <option>R200,000+</option>
                            <option>R400,000+</option>
                            <option>R600,000+</option>
                            <option>R800,000+</option>
                            <option>R1,000,000+</option>
                            <option>R1,200,000+</option>
                            <option>R1,500,000+</option>
                            <option>Any</option>
                        </select>
                    </div>
                    <div className='listingform__section'>

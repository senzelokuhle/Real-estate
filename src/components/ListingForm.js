...
const ListingForm = (props) => {
    ...
    const onSubmit = e => {
        ...
        setLoading(true);
        axios.post(`http://104.236.91.135/api/listings/search`, {sale_type, price, bedrooms, home_type, bathrooms, sqft, days_listed, has_photos, open_house, keywords }, config)
        .then(res => {
            setLoading(false);

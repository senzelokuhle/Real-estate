...
const ListingDetail = (props) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://104.236.207.118/api/listings/${slug}`, config)
        .then(res => {
            setListing(res.data);
    ...
    useEffect(() => {
        ...
        if (id) {
            axios.get(`http://104.236.207.118/api/smart_stay/${id}`, config)
            .then(res => {
                setRealtor(res.data);
            })
            .catch(err => {
            ...
            <div className='row'>
                <div className='col-1-of-2'>
                    <ul className='listingdetail__list'>
                        ...
                        <li className='listingdetail__list__item'>Price: R{price}</li>
